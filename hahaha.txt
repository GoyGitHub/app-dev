...
password_entry = Entry(frame, width=30, font=("Arial", 12))
password_entry.grid(row=1, column=1, columnspan=2 ,padx=10, pady=10)

button_ok = Button(frame, padx=10, pady=10, text="Login", font=("Arial", 12), width=10, bg="Green", fg="White")
button_ok.grid(row=2, column=1)

button_cancel = Button(frame, padx=10, pady=10, text="Kansel", font=("Arial", 12), width=10, bg="Red", fg="White")
